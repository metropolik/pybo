    ...
    while((recvPacket.rpos() < recvPacket.size())&& (readblocks < ublocks))
    {
        ...
        switch(utype)
        {
            ...
            case UPDATETYPE_CREATE_OBJECT: // will be sent on any other object creation
            {
                    ...
                    case TYPEID_ITEM:
                        {
                            ...
                            item->Create(uguid);
                            objmgr.Add(item);
                            logdebug("Created Item with guid %ld",uguid);
                            break;
                        }
                    case TYPEID_CONTAINER:
                        {
                            ...
                            bag->Create(uguid);
                            objmgr.Add(bag);
                            logdebug("Created Bag with guid %ld",uguid);
                            break;
                        }
                    case TYPEID_UNIT:
                        {
                            ...
                            unit->Create(uguid);
                            objmgr.Add(unit);
                            logdebug("Created Unit with guid %ld",uguid);
                            break;
                        }
                    case TYPEID_PLAYER:
                        {
                            ...
                            player->Create(uguid);
                            objmgr.Add(player);
                            logdebug("Created Player with guid %ld",uguid);
                            break;
                        }
                    case TYPEID_GAMEOBJECT:
                        {
                            ...
                            go->Create(uguid);
                            objmgr.Add(go);
                            logdebug("Created GO with guid %ld",uguid);
                            break;
                        }
                    case TYPEID_CORPSE:
                        {
                            ...
                            corpse->Create(uguid);
                            objmgr.Add(corpse);
                            logdebug("Created Corpse with guid %ld",uguid);
                            break;
                        }
                    case TYPEID_DYNAMICOBJECT:
                        {
                            ...
                            dobj->Create(uguid);
                            objmgr.Add(dobj);
                            logdebug("Created DynObj with guid %ld",uguid);
                            break;
                        }
                    }
                }
                ...
                {
                    logdebug("Obj %ld not created, already exists",uguid);
                }
